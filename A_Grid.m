function [route,n] = A_Grid(input_map,start_coords,goal_coords,drawMapEveryTime)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        [map,ary,fnd,u,d,r,l] = search(n,ary,input_map,map,Visited_Frontier,goal_node);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        % Heuristic Function used in search file
        ...
        if chk == u
            [Visited_Frontier] = U_A(ary,n,map);
        end
        if chk == d
            [Visited_Frontier] = D_A(ary,n,map);
        end
        if chk == l
            temp = ary(n).l;
            if temp ~= 0
        ...
        if chk == r
            [Visited_Frontier] = R_A(ary,n,map);
        end
